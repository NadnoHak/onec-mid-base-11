...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//Вызов процедуры Добавление поля КонтактноеЛицо в форме документов
	 Нетология_ДополнитьФормуКонтактноеЛицо(Форма);
...
/////////////////////Изменение конфигураций Нетология
/////////////////////Добавление поля КонтактноеЛицо в форме документов
Процедура  Нетология_ДополнитьФормуКонтактноеЛицо(Форма) Экспорт
    //////Изменение Конфигураций Нетология
	//////////Выбор процедуры для добовление поле Контактноелицо в зависимости от документа
	ИмяФормы = Форма.ИмяФормы;
	
	Если ИмяФормы = "Документ.ПоступлениеТоваровУслуг.Форма.ФормаДокумента" ИЛИ ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" ИЛИ ИмяФормы = "Документ.РеализацияТоваровУслуг.Форма.ФормаДокумента"  Тогда
...
////////////////////////Изменение конфигураций Нетология
////////Вызов процедуры добавление поле КонтактноеЛицо на формы документа
Процедура ДобавитьПолеКонтактноеЛицоВГруппаШапкаПраво(Форма)
	//////////Изменеие конфигураций Нетология
	///Добавление полеКонтактноеЛицо на форму документа
	ПолеВвода = Форма.Элементы.Добавить("Нетология_КонтактноеЛицо", Тип("ПолеФормы"), Форма.Элементы.ГруппаШапкаПраво);
...
Процедура ДобавитьПолеКонтактноеЛицоНаФормуПередСуммаДокумента(Форма)
	//////////Изменеие конфигураций Нетология
	///Добавление полеКонтактноеЛицо на форму документа
	ПолеВвода = Форма.Элементы.Вставить("Нетология_КонтактноеЛицо", Тип("ПолеФормы"), , Форма.Элементы.СуммаДокумента);
	ПолеВвода.Заголовок = "Контактное Лицо";
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "Объект.Нетология_КонтактноеЛицо";
